...
namespace formularz___lab_9
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            dbPath = "egzamin_komisyjny.db";
            lblSciezkaBazy.Text = $"Baza danych: {dbPath}";
        ...
        private void btnWybierzBaze_Click(object sender, EventArgs e)
        {
            ...
            {
                dialog.Filter = "Baza SQLite (*.db)|*.db|Wszystkie pliki (*.*)|*.*";
                dialog.Title = "Wybierz lokalizację bazy danych";
                dialog.FileName = "egzamin_komisyjny.db";
